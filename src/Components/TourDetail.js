...
export default function TourDetail() {
	const [tour_detail, setTour_detail] = useState([{ id: 1, name: "hoa" }]);
	...
	useEffect(async () => {
		...
		let res_list_cmt = await API.get(
			endpoints["get_tour_detail_get_cmt"](tourdetailId)
		);
		...
		if (user_selector !== null && user_selector !== undefined) {
			...
			let res_rating = await API.post(
				endpoints["get_rating"](tourdetailId),
				{
					id: res_user.data.id
				},
				{
	...
	let add_cmt = async event => {
		...
		try {
			let res_cmt = await API.post(
				endpoints["add_cmt"](tourdetailId),
				{
					content: cmt_content
				},
				{
	...
	const rating_action = async event => {
		event.preventDefault();
		try {
			let resrate = await API.post(
				endpoints["add_rating"](tourdetailId),
				{
					rating: rating
				},
				{
		...
		let update = async () => {
			try {
				...
				let res = await API.patch(
					endpoints["tour_detail"](tourdetailId),
					formdata,
					{
						headers: {
	...
	if (user.length != 0) {
		...
		bk_src = (
			<div className="table_item item_booking">
				...
				<div className="entry_header py-5">
					<div className="container">
						...
						<div
							className="entry_br"
							style={{
								backgroundImage: `url(${tour_detail.image})`
							}}
						></div>
					</div>
				</div>
						...
						<div className="row">
							<div className="col-md-9">
								<div className="about_tour" id="about">
									...
									<p className="content_tour">
										{tour_detail.content}
									</p>
									<div className="thing_to_do">
										<h4 style={{ fontSize: "20px" }}>
											Things to do in {tour_detail.name}
										</h4>
										<div className="row">
                            ...
                            <span>
								...
								<div className="cost" id="cost">
									...
									<div className="typical_cost">
										...
										<span>
											– Quo at mollis tritani molestie,
											munere vivendum sit ei, nec congue
											bonorum an. In quidam iriure alienum
											nam, in scripta probatus usu.
											Aperiam tractatos ex his, ex usu
											facete accumsan, duo platonem
											efficiantur intellegebat ut.
											Accusata scripserit persequeris pri
											eu, accusam argumentum disputationi
											an his. Nulla erant urbanitas sed
											ne, mei velit laudem id, nonumy
											eligendi pri ei. Eu mel everti
											ocurreret, nemore quodsi referrentur
											ius ad.
										</span>
									</div>
									<div className="typical_cost">
										...
										<div className="tips_left">
											<div className="tips_content">
												...
												<div className="things_content">
													...
													<span>
														{" "}
														- Accusata vulputate pri
														an, mel no vivendo
														deleniti, aliquid
														probatus elaboraret ut
														quo. Veniam facete
														intellegebat et mei,
														cetero luptatum
														definiebas at nec. Nisl
														viris.
													</span>
												</div>
											</div>
								...
								<div className="calender" id="calender">
									...
									<p className="content_calender">
										...
										consequat auctor eu in elit. Class
										aptent taciti sociosqu ad litora
										torquent per conubia nostra, per
										inceptos himenaeos. Mauris in erat
										justo. Nullam ac urna eu felis dapibus
										condimentum sit amet a augue consequat
										elis. Proin gravida nibh vel velit
										auctor aliquet. Aenean sollicitudin,
										lorem quis bibendum auctor, nisi elit
										consequat ipsum, nec sagittis sem nibh
										id elit. Duis sed odio sit amet nibh
									...
									<div className="extra_info">
										<div className="tag_info">
											...
											<span>
												{/* {} */}
												<a
													href={`/search/?tag=${return_null(
														tour_detail
													)}`}
												>
													{return_null(tour_detail)}
												</a>
											</span>
											<span className="icon_cmt_extra">
							...
							<div className="col-md-3">
								<div className="table_of_content d-flex">
									<div className="table_item">
										<a href="#about">
											<img
												src="https://backpacktraveler.qodeinteractive.com/wp-content/uploads/2018/08/destination-custom-icon-1.png"
												alt="cmm"
											/>
									...
									<div className="table_item">
										<a href="#cost">
											<img
												src="https://backpacktraveler.qodeinteractive.com/wp-content/uploads/2018/08/destination-custom-icon-2.png"
												alt="cmm"
											/>
									...
									<div className="table_item">
										<a href="#tips">
											<img
												src="https://backpacktraveler.qodeinteractive.com/wp-content/uploads/2018/08/destination-custom-icon-3.png"
												alt="cmm"
											/>
									...
									<div className="table_item">
										<a href="#calender">
											<img
												src="https://backpacktraveler.qodeinteractive.com/wp-content/uploads/2018/08/destination-custom-icon-5-1.png"
												alt="cmm"
											/>
									...
									<div className="table_item">
										<a href="#cmt_and_rate">
											<img
												src="https://backpacktraveler.qodeinteractive.com/wp-content/uploads/2018/08/destination-custom-icon-6-1.png"
												alt="cmm"
											/>
