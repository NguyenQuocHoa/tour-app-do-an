...
export default function Header() {
	...
	let logout_path = (
		<div className="logout_path" onClick={logout}>
			<span>Logout</span>
		</div>
	);
	...
	let src_img = `${unknow}`;
	let dropdown = (
		<a href="/login" className="src_login">
			Login
		</a>
	);
			...
			dropdown = (
				<NavDropdown title={name} id="" className="">
					<div className="dropdown_wrapper">
						<div className="">
							<span>
								<a href="/account_detail">Account</a>
							</span>
						</div>
						<div className="">
							<span>
								<a href="/list_user">User manage</a>
							</span>
						</div>
						<div className="">
							<span>
			...
			<div className="account_path">
				<div className="path_wrapper">
					<div className="img_header">
						<a href="/login">
							<img src={src_img} alt="unknow" />
						</a>
					</div>
					<div className="name_user">{dropdown}</div>
				</div>
			</div>
		</>
	);
	return (
		<>
			<Navbar expand="lg">
				<Navbar.Brand href="/">
					Stormy <span className="text-logo">Travel</span>{" "}
				</Navbar.Brand>
				<Navbar.Toggle />
				<Navbar.Collapse>
					<Nav className="ml-auto">
						...
						<NavDropdown
							title="Tour"
							id="tour_dropdown"
							className="tour_dropdown"
						>
							<div className="row_wrapper">
								<div className="row">
									<div className="col-md-3">
										<div className="title_domain">
											<a href="/departure/?tag=north">
												North Side
											</a>
										</div>
						...
						<Nav.Link href="/order_list">Đơn hàng</Nav.Link>
						{path}
					</Nav>
				</Navbar.Collapse>
			</Navbar>
